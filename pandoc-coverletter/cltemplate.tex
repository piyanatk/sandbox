...
\usepackage[$papersize$,margin=1in]{geometry}
...
\header{$head.address$}{$head.city$}{$head.state$}{$head.zip$}{$head.country$}{$head.phone$}{$head.fax$}{$head.email$}{$sig.name$}{$head.dept$}
